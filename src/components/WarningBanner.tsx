      ...
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 text-amber-900 text-sm">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="mt-0.5 opacity-90">
            A infraestrutura de nuvem da Amazon (AWS) está enfrentando falhas sistêmicas hoje (05/03). Devido a essa instabilidade técnica, a nossa atualização de preços em tempo real está temporariamente pausada e o checkout na Amazon pode apresentar lentidão. Estamos exibindo o último preço validado pelo nosso sistema para garantir sua referência de comparação.
          </p>
        </div>
      </div>
    </div>
