...
export function MobileProductCard({
  ...
  return (
    <div className="flex gap-3 border-b border-gray-100 bg-white relative items-stretch min-h-[250px] font-sans">
      ...
      <div className="flex flex-col flex-1 pr-2 py-4 min-w-0">
        ...
        <div
          className={`bg-white border border-zinc-200 rounded p-2 mb-3 grid grid-cols-2 gap-2 divide-x divide-zinc-200 ${
            rating === 0 ? "mt-2" : ""
          }`}
        >
