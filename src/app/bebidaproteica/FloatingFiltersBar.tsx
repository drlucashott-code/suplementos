...
export function FloatingFiltersBar() {
  ...
  // O padrão é 'discount' (Maior desconto)
  ...
  function changeOrder(value: string) {
    ...
    // ✅ Navegação garantida na rota de bebida proteica
    router.push(`/bebidaproteica?${params.toString()}`, { scroll: false });
  }

  // Lógica de Performance e UX: Barra some ao rolar para baixo e aparece ao rolar para cima
        ...
        <div className="flex-1 flex items-center gap-2">
          ...
          <div className="flex-1 relative">
            ...
            >
              ...
              <option value="cheapest_unit">Menor preço/unidade</option>
              <option value="cost">Melhor custo-benefício (g de proteína)</option>
            </select>
