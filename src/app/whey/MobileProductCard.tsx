...
export function MobileProductCard({
  ...
  // Proteções contra valores undefined/null
  const rating = product.rating ?? 0;
  const reviewsCount = product.reviewsCount ?? 0;
  
  // ✅ Correção do Erro: Garantindo que proteinPercentage exista antes do toFixed
      ...
      <div className="flex flex-col flex-1 pr-2 py-4">
        ...
        <div className="flex gap-2 mb-1">
          ...
          <span className="text-[10px] bg-gray-50 text-gray-600 px-1.5 py-0.5 rounded border border-gray-200 font-medium italic">
            {product.proteinPerDose}g de proteína / dose
          </span>
        </div>
