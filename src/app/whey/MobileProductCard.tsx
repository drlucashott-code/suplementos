...
export function MobileProductCard({
  ...
  product: WheyProduct;
  priority: boolean;
  isBest?: boolean; // compatibilidade
}) {
  ...
  const proteinPct = Math.round(product.proteinPercentage);
  ...
  return (
    <div className="flex gap-3 border-b border-gray-100 bg-white relative items-stretch min-h-[290px] font-sans">
      ...
      {/* Coluna da Imagem (IGUAL CREATINA) */}
      ...
      <div className="flex flex-col flex-1 pr-2 py-4">
        ...
        {/* TABELA TÉCNICA (mesmo layout da Creatina) */}
            ...
            <>
              ...
              <div className="mt-1 flex items-center">
                <span className="font-black italic text-[12px] leading-none flex items-center">
                  <span className="not-italic text-[13px] text-[#FEBD69] mr-0.5">✓</span>
