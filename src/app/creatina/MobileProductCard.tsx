  ...
  return (
    <div className="flex gap-3 border-b border-gray-100 bg-white relative items-stretch min-h-[240px]">
      ...
      {/* 🚀 CORREÇÃO DE POSICIONAMENTO:
          - w-[140px] e flex-shrink-0 garantem que a imagem tenha sua própria coluna fixa.
          - bg-[#f3f3f3] preenche o fundo da coluna da imagem.
      */}
      <div className="w-[140px] bg-[#f3f3f3] flex-shrink-0 overflow-hidden relative flex items-center justify-center p-2">
        <Image
          ...
          width={230}
          height={230}
          /* ⚡ PERFORMANCE: sizes="140px" impede o download de imagens 4K no mobile */
          sizes="140px"
          priority={priority} 
      ...
      {/* Coluna de Informações (flex-1 garante que o texto ocupe o restante do espaço) */}
      <div className="flex flex-col flex-1 pr-2 py-4">
        ...
        {/* Informações Extras (Acessibilidade Zinc para Score 100) */}
