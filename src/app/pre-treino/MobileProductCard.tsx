...
export type Product = {
  ...
  doses: number | null;
  pricePerDose: number; 
  caffeinePerDose: number; // Agora em MG
  doseWeight: number;      // Agora em Gramas (tamanho do scoop)
...
export function MobileProductCard({
  ...
  // Price per Dose já vem calculado do page.tsx
  const pricePerDose = hasPrice ? product.pricePerDose.toFixed(2) : null;
           ...
           <div className="flex items-center justify-around text-center pt-1">
              <div className="flex flex-col flex-1">
                 <span className="text-[13px] font-bold text-[#0F1111] leading-none">
                    {/* Exibe MG de cafeína ou "0" se for sem estimulante */}
                    {product.caffeinePerDose > 0 ? `${product.caffeinePerDose}mg` : "0mg"}
                 </span>
                 <span className="text-[9px] text-zinc-500 mt-0.5">cafeína</span>
              </div>
              ...
              <div className="flex flex-col flex-1">
                 ...
                 <span className="text-[9px] text-green-700 font-medium mt-0.5">por dose</span>
              </div>
           </div>
        </div>
